          ...
          /*  case "24":{
           ...
           /* case "29": {//TEST29
            ...
            case "34": {//TEST34
                ...
                nav_dome.toDomeEncodingLow(page,ip);
                a0 = encodingLow_dome.test_intraframe_2(page);
                a1 = encodingLow_dome.test_bit_con_2(page);
                a3 = encodingLow_dome.test_bit_rate_2(page);
                a2 = encodingLow_dome.test_codding_quality_2(page);
                if(a0[2] && a1[2] && a2[2] && a3[2])
                await result.write("33","BAŞARILI   Intraframe = "+a0[1]+"  Bit kontrol metodu = "+a1[1]+"  Kodlayıcı kalitesi = "+a2[1]+"  Bitrate = "+a3[1]);
                else
                await result.write("33","BAŞARISIZ   Intraframe = "+a0[1]+"  Bit kontrol metodu = "+a1[1]+"  Kodlayıcı kalitesi = "+a2[1]+"  Bitrate = "+a3[1]);
                break;
            }
             case "35": {//TEST35
                console.log(" ");
            ...
            case "36": { //TEST 36
                ...
                if ( (select1 == "h" || select1 == "H") && (select2 =="e"|| select2=="E"))
                {    console.log("Test Başarılı");
                await result.write("36"," BAŞARILI");}
                else
                {await result.write("36"," BAŞARISIZ");
                console.log("Test Başarısız")}
                break;
            }
            case "37": { //TEST 37
                ...
                if ( (select1 == "e" || select1 == "E") && (select2 =="e"|| select2=="E"))
                {  console.log("Test Başarılı");
                await result.write("37"," BAŞARILI");}
                else
                { console.log("Test Başarısız")
                await result.write("37"," BAŞARISIZ");}
                break;
            }
            case "38": { //TEST 38
                ...
                if ( (select1 == "e" || select1 == "E") && (select2 =="e"|| select2=="E"))
                {  console.log("Test Başarılı");
                await result.write("38"," BAŞARILI");}
                else
                { console.log("Test Başarısız")
                await result.write("38"," BAŞARISIZ");}
                break;
            }
            case "39": { //TEST 39
                ...
                proc =await require('child_process').exec(command);
                select1 = await question.ask("Görüntü Geldi mi ? e/h");
                console.log("Vlc üzerinden çözünürlüğü kontrol edin.. İstenen çözünürlük 640*368")
                select2 = await question.ask("Görüntü istenen çözünürlükte mi ? e/h");
                if ( (select1 == "e" || select1 == "E") && (select2 =="e"|| select2=="E"))
                {    console.log("Test Başarılı");
                await result.write("39"," BAŞARILI");}
                else
                {  console.log("Test Başarısız")
                await result.write("39"," BAŞARISIZ");}
                break;
            }
            case "42": {//TEST 42
                console.log(" ");
                ...
                await result.write("42"," UYGULANDI    Yazılım sürümü="+firmware+"  Uygulama sürümü = "+application);
                break;
            }
            case "43": { //TEST-43
                console.log("");
            ...
            case "51": {//TEST51
                ...
                console.log("OPTIONS SETTED ");
                page.reload();
                await login.loginCamera(page, '10.5.177.164');
                await nav_dome.toDomeCamera(page,ip);
                await page.waitFor(4000);
            ...
            case "81":{//81,82,83
                ...
                console.log("Kamera desene 2 dakika içerisnde başlamazsa 'x' tuşuna basın.")
            ...
            case "84":{//84-94 arası
                ...
                if(select1=="e"||select1=="E"){
                    ...
                    for(var i=0 ; i<5 ; i++){
                        ...
                        console.log("Kabloyu yeniden takıp Enter tuşuna basın");
            ...
            case "95":{//95-98 arası
                ...
                if(select1=="e"||select1=="E")
                {
                    ...
                    await result.write("95","BAŞARISIZ    Kamera deseni gerçekleştirmiyor.")
                }
                else
            ...
            case "99":{//99-101 arası
                ...
                if(select1=="e"||select1=="E"){
                    ...
                    if(select4=="e"||select4=="E")
                    {  select4=1; times[2]=child_process.execSync("date +%T");
            ...
            case "102":{//102-105
                ...
                if(select1=="e"||select1=="E")
                {
                    ...
                    await result.write("102","BAŞARISIZ    Kamera deseni gerçekleştirmiyor.")
                }
                else
            ...
            case "110":{
                ...
                {
                    console.log("Lütfen aşağıdaki testi uygulayın. Ardından otomatik test yazılımını tekrardan başlatın ve test sonuçlarını otomatik test yazılımına bildirmek için bu testin numarasını tuşlayın");
                    console.log("Kamera patrole devam ederken kameranın gücü kesilir. Bir süre(15 - 20 sn) beklendikten sonra kameranın gücü tekrardan verilir. Kamera açıldıktan sonra daha önce yapmakta olduğu işe devam ettiği kameranın hareketi gözlemlenerek doğrulanır.");
                    select = await question.ask("Kamera açıldıktan sonra patrole devam etti mi? e/h");
                    if (select=="e"||select=="E")
                    { console.log("Test Başarılı");
            ...
            case "125" : {
                ...
                if(select1)
                {
                    ...
                    await result.write("125","BAŞARISIZ    Alarm var olduğu sürece DEFNE'de sol üst köşede SEI Alarm bilgisi gelmedi")
                }
                else
            ...
            case "132" : {
                ...
                if (select0=="H" || select0 == "h")
                {
                    ...
                    if (select1=="e"||select1=="E")
                    {
                        result.write("129","BAŞARILI    Alarm başlama saati"+times[0]+"Alarmı sonlandırma saati:"+times[1]+"Hareket olmadığının en son kontrol edildiği saat:"+times[3])
                    }
                    else result.write("129","BAŞARISIZ    Alarm başlatıldığında kamera alarm presetine yönelmiyor.")
                }
                else result.write("129","BAŞARISIZ    Kamera patrole yeniden başlıyor.")
            break; }
