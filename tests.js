...
{   console.log("Kamera kaydı alınıyor..")
    ...
    if (coded_width == width_test && coded_height == height_test)
    {
        ...
        if(select=='e'||select=='E') await result.write(test_num," BAŞARILI    Görüntü geldi , Çözünürlükler eşit    İstenen Çözünürlük="+width_test+"x"+height_test+"  Gerçekleşen çözünürlük ="+coded_width+"x"+coded_height);
        else await result.write(test_num," BAŞARISIZ    Görüntü gelmedi ");
    }
    else {console.log("Çözünürlükler Farklı");
        if(select=='e'||select=='E') await result.write(test_num," BAŞARISIZ    Görüntü geldi , Çözünürlükler eşit değil    İstenen Çözünürlük="+width_test+"x"+height_test+"  Gerçekleşen çözünürlük ="+coded_width+"x"+coded_height);
        else await result.write(test_num," BAŞARISIZ    Görüntü gelmedi ");
    }
...
async function test_ffmpeg_res_fps(stream,test_num)
{
    ...
    if (temp_val) await result.write(test_num," BAŞARILI   İstenen kare hızı = "+r_frame_rate+" Gerçekleşen kare hızı = "+avg_frame_rate+" İstenen çözünürlük = "+width+"x"+height+" Gerçekleşen çözünürlük = "+coded_width+"x"+coded_height);
    else await result.write(test_num," BAŞARISIZ   İstenen kare hızı = "+r_frame_rate+" Gerçekleşen kare hızı = "+avg_frame_rate+" İstenen çözünürlük = "+width+"x"+height+" Gerçekleşen çözünürlük = "+coded_width+"x"+coded_height);
}
...
(function() {
	...
	ip = url;
            switch(test_number.toString()){
                ...
                case "16" : {await test_ffmpeg_res("1920","1080","stream1","16"); break;}
                ...
                case "21" : {
                    ...
                    await result.write("21", "4 adet maske oluşturuldu ve konumlandırıldı.");
                    break;
                }
                case "22": {console.log(" ");
                        ...
                        await result.write("22", "Konfigürasyon ayarları yapıldı.");
                    break;
                }
                case "23": {// Kontrol 23
                        console.log(" ");
			...
			await encodingLow.set_bit_con(page, "cbr");
                        ...
                        console.log("Konfigürasyon ayarları yapıldı.");
                        await result.write("23", "Konfigürasyon ayarları yapıldı.");
                    break;
                }
                case "24": {//Kontrol 24
                        console.log(" ");
                        ...
                        await resolution.apply(page);
                        console.log("Konfigürasyon ayarları yapıldı.");
                        await result.write("24", "Konfigürasyon ayarları yapıldı.");
                    break;
                }
                case "25": {//Kontrol 25
                        console.log(" ");
                        ...
                        console.log("Konfigürasyon ayarları yapıldı.");
                        await result.write("25", "Konfigürasyon ayarları yapıldı.");
                    break;
                }
                case "28": {// TEST 28
                      console.log(" ");
                      ...
                      if((initframe == 1) && (bitcon == 1) && (quality == 1) && (bitrate == 1) && (method == 1))
                        {
                            ...
                            await result.write("28", "Test Başarılı. Konfigürasyon Ayarları Doğru.");
                        }
                      else
                        {
                            console.log("Konfigürasyon Ayarları Yanlış.");
                            await result.write("28", "Test Başarısız. Konfigürasyon Ayarları Yanlış.");
                        }
                        break;
                }
                case "29": {// TEST 29
                      ...
                      if((initframe == 1) && (bitcon == 1) && (quality == 1) && (bitrate == 1))
                        {
                            console.log("Konfigürasyon Ayarları Doğru.");
                            await result.write("29", "Test Başarılı. Konfigürasyon Ayarları Doğru.");
                        }
                      else
                        {
                            console.log("Konfigürasyon Ayarları Yanlış.");
                            await result.write("29", "Test Başarısız. Konfigürasyon Ayarları Yanlış.");
                        }
                        break;
                }
                case "30": { // TEST 30
                      ...
                      if((profile == 1) && (res1 == 1) && (fps1 == 1) && (res2 == 1) && (fps2 == 1))
                        {
                            console.log("Konfigürasyon Ayarları Doğru.");
                            await result.write("30", "Test Başarılı. Konfigürasyon Ayarları Doğru.");
                        }
                      else
                        {
                            console.log("Konfigürasyon Ayarları Yanlış.");
                            await result.write("30", "Test Başarısız. Konfigürasyon Ayarları Yanlış.");
                        }
                        break;
                }
                case "31": { //TEST 31
                      ...
                      if ( (select1 == "h" || select1 == "H") && (select2 =="e"|| select2=="E"))
                      {
                          ...
                          await result.write("31", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("31", "Test Başarısız");
                      }    
                    break;
                ...
                case "32": { //TEST 32
                    console.log("Test 32 Başladı.");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("32", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("32", "Test Başarısız");
                      }
                      break;
                }
                case "33": { //TEST 33
                    console.log("Test 33 Başladı.");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("33", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("33", "Test Başarısız");
                      }
                      break;
                }
                case "34": { //TEST 34
                    console.log("Test 34 Başladı.");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("34", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("34", "Test Başarısız");
                      }
                      break;
                }
                case "35": { //TEST 35
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("35", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("35", "Test Başarısız");
                      }
                      break;
                }
                case "36": { //TEST 36
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("36", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("36", "Test Başarısız");
                      }
                      break;
                }
                ...
                case "37": {//TEST 37
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("37", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("37", "Test Başarısız");
                      }
                      break;
                }
                case "38": {//TEST 38
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("38", "Test Başarılı");  
                      }    
                      else if (sei == 0)
                      {
                          console.log("Test Başarısız")
                          await result.write("38", "Test Başarısız");
                      }
                      break;
                }
                case "39": {//TEST 39
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("39", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("39", "Test Başarısız");
                      }
                      break;
                }
                case "40":{//TEST 40
                      ...
                      select2 = await question.ask("Sol üst köşede kırmızı fontlu alarm bilgisi geldi mi? e/h");
                       ...
                       {
                          console.log("Test Başarılı");
                          await result.write("40", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("40", "Test Başarısız");
                      }
                      break;
                ...
                case "41": {//TEST 41
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("41", "Test Başarılı");  
                      }    
                      else if ((ir_mode != 1) && (ir_transition == 1))
                      {
                          console.log("Test Başarısız")
                          await result.write("41", "Test Başarısız");
                      }
                      else if ((ir_mode == 1) && (ir_transition != 1))
                      {
                          console.log("Test Başarısız")
                ...
                case "42": {//TEST 42
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("42", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("42", "Test Başarısız");
                      }
                      break;
                }
                case "43": {//TEST 43
                     console.log("Test 43 Başladı.");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("43", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("43", "Test Başarısız");
                      }
                      break;
                ...
                case "44":{
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("44", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("44", "Test Başarısız");
                      }
                      break;
                }
                case "45":{
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("45", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("45", "Test Başarısız");
                      }
                      break;
                }
                case "46": {//TEST 46
                ...
                case "47":{
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("47", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("47", "Test Başarısız");
                      }
                      break;
                ...
                case "48":{
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("48", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("48", "Test Başarısız");
                      }
                      break;
                }
                case "49":{
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("49", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("49", "Test Başarısız");
                      }
                      break;
                }
                case "50":{
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("50", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("50", "Test Başarısız");
                      }
                      break;
                }
                case "51":{
                    console.log("Test 51 Başladı.");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("51", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("51", "Test Başarısız");
                      }
                      break;
                }
                case "52":{
                    console.log("Test 52 Başladı.");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("52", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("52", "Test Başarısız");
                      }
                      break;
                }
                ...
                case "61": {
                    ...
                    select2 = await question.ask("Yayın geldi mi? e/h");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("61", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("61", "Test Başarısız");
                      }
                      break;
                }
                case "62": {
                    ...
                    select2 = await question.ask("Yayın geldi mi? e/h");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("62", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("62", "Test Başarısız");
                      }
                      break;
                }
                case "63": {
                    ...
                    select2 = await question.ask("Yayın geldi mi? e/h");
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("63", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("63", "Test Başarısız");
                      }
                      break;
                }
                case "65": {//TEST 65
                      ...
                      select2 = await question.ask("Sol üst köşede kırmızı fontlu alarm bilgisi geldi mi? e/h");
                       ...
                       {
                          console.log("Test Başarılı");
                          await result.write("65", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("65", "Test Başarısız");
                      }
                      break;
                }
                case "66":{//TEST 66
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("66", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("66", "Test Başarısız");
                      }
                      break;
                ...
                case "69":{//TEST 69
                      ...
                      select2 = await question.ask("Maskelerin konumları aynı mı? e/h");
                       ...
                       {
                          console.log("Test Başarılı");
                          await result.write("69", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("69", "Test Başarısız");
                      }
                      break;
                }
                   case "70":{//TEST 70
                      ...
                      {
                          console.log("Test Başarılı");
                          await result.write("70", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("70", "Test Başarısız");
                      }
                      break;
                }
                case "71" : {
                    ...
                    await mask.mask_refresh(page);
                        ...
                        {
                          console.log("Test Başarılı");
                          await result.write("71", "Test Başarılı");  
                      }    
                      else
                      {
                          console.log("Test Başarısız")
                          await result.write("71", "Test Başarısız");
                      }
                      break;
                }
    ...
    module.exports.start_2 = async function(page, test_number,url) {
        ...
        switch(test_number){
            case "14" : {
    try{ await test_ffmpeg_res("1920","1080","stream1m","14"); }catch (err){ console.log("HATA");} break;}
            case "15" : {try{await test_ffmpeg_res("640","368","stream2m","15");}catch (err){ console.log("HATA");} break;}
            case "16" : {try{await test_ffmpeg_res("1920","1080","stream1","16");}catch (err){ console.log("HATA");} break;}
            case "17" : {try{await test_ffmpeg_res("640","368","stream2","17");}catch (err){ console.log("HATA");} break;}
            case "21":{
                ...
                if ( select1 == "e" || select1 == "E")
                {console.log("Test Başarılı");
                    await result.write("21"," BAŞARILI");
                }
                else
                { console.log("Test Başarısız");
                    await result.write("21"," BAŞARISIZ");
                }
            ...
            case "22": {
                ...
                await camera_restart(page,ip);
                await result.write("22"," UYGULANDI    Ayarlar kaydedildi");
            ...
            case "23": {//TEST23
                ...
                await result.write("23"," UYGULANDI    Ayarlar kaydedildi");
                console.log("OPTIONS SETTED ");
                break;
            }
          /*  case "24":{
                console.log(" ");
                console.log("TEY-2_ver06 Test-24 STARTED");
                await nav_dome.toDomeCamera(page,ip);
                for(let i=0; i<9 ; i++){
                    await page.waitFor(2000);
                await cam.delete_pattern(page,i);}
                for(let i=0; i<8 ; i++){
                    await page.waitFor(2000);
                    var pattern_name= "pattern"+(i+1);
                await cam.add_pattern(page,i,pattern_name);}
                console.log("OPTIONS SETTED ");
                break;
            }*/
            case "27": {//TEST27
                ...
                await result.write("27"," UYGULANDI    Ayarlar kaydedildi");
                await camera_restart(page,ip);
                console.log("OPTIONS SETTED ");
                break;
            }
            case "28": {//TEST28
                ...
                await result.write("28","UYGULANDI    Ayarlar kaydedildi");
                await camera_restart(page,ip);
                console.log("OPTIONS SETTED ");
                break;
            }
           /* case "29": {//TEST29
                ...
                await resolution.set_fps1(page,"10");
                await resolution.apply(page);
                await result.write("29"+" UYGULANDI    Ayarlar kaydedildi");
                await camera_restart(page,ip);
                console.log("OPTIONS SETTED ");
                break;
            }*/
            case "30": {
                ...
                await result.write("30"," UYGULANDI    Ayarlar kaydedildi");
                console.log("OPTIONS SETTED ");
                break;
            }
            case "33": {//TEST33
                ...
                await result.write("33","BAŞARILI   Intraframe = "+a0[1]+"  Bit kontrol metodu = "+a1[1]+"  Kodlayıcı kalitesi = "+a2[1]+"  Bitrate = "+a3[1]+"  Bitrate hesaplama metodu = "+a4[1]+"  Video kalite yüzdesi = "+a4[4]);
                else
                await result.write("33","BAŞARISIZ   Intraframe = "+a0[1]+"  Bit kontrol metodu = "+a1[1]+"  Kodlayıcı kalitesi = "+a2[1]+"  Bitrate = "+a3[1]+"  Bitrate hesaplama metodu = "+a4[1]+"  Video kalite yüzdesi = "+a4[4]);
                break;
            }
            case "34": {//TEST34
                console.log(" ");
                ...
                await result.write("34","BAŞARILI   Intraframe = "+a0[1]+"  Bit kontrol metodu = "+a1[1]+"  Kodlayıcı kalitesi = "+a2[1]+"  Bitrate = "+a3[1]);
                else
                await result.write("34","BAŞARISIZ   Intraframe = "+a0[1]+"  Bit kontrol metodu = "+a1[1]+"  Kodlayıcı kalitesi = "+a2[1]+"  Bitrate = "+a3[1]);
                break;
            }
             case "35": {//TEST35
                console.log(" ");
                ...
                if(temp_val0[2] && temp_val1[2] && temp_val2[2] && temp_val3[2] && temp_val4[2])
                    await result.write("35","BAŞARILI Profil ="+temp_val0[1]+" Yayın1 Çözünürlük ="+temp_val1[1]+" FPS1 ="+temp_val2[1]+" Yayın2 Çözünürlük ="+temp_val3[1]+" FPS2 ="+temp_val4[1]);
                else
                    await result.write("35","BAŞARISIZ Profil ="+temp_val0[1]+" Yayın1 Çözünürlük ="+temp_val1[1]+" FPS1 ="+temp_val2[1]+" Yayın2 Çözünürlük ="+temp_val3[1]+" FPS2 ="+temp_val4[1]);
                break;
            } 
            case "36": { //TEST 36
                console.log("Test 36 Başladı");
                ...
                if (select0 == "e" || select0 == "E")
                {
                    ...
                    {    console.log("Test Başarılı");
                    await result.write("36"," BAŞARILI Görüntüde bozulmalar yok ve istenen çözünürlükte");}
                    else
                    {await result.write("36"," BAŞARISIZ    Görüntünün çözünürlüğü yanlış.");
                    console.log("Test Başarısız")}
                    }
                    else
                    { await result.write("36"," BAŞARISIZ    Görüntüde bozulmalar var.");
                        console.log("Test başarısız Görüntüde bozulmalar var.")
                    }
                }
                else
                {await result.write("36"," BAŞARISIZ     Görüntü gelmiyor.");
            ...
            case "37": { //TEST 37
                ...
                if ( (select1 == "e" || select1 == "E") && (select2 =="e"|| select2=="E"))
                {  console.log("Test Başarılı");
                await result.write("37"," BAŞARILI    Görüntü çözünürlüğü doğru.");}
                else
                { console.log("Test Başarısız")
                await result.write("37"," BAŞARISIZ    Görüntünün çözünürlüğü yanlış.");}
                    
                }
                else 
                    await result.write("37"," BAŞARISIZ    Görüntü gelmiyor.");
                break;
            }
            case "38": { //TEST 38
                ...
                if ( (select1 == "e" || select1 == "E") && (select2 =="e"|| select2=="E"))
                {  console.log("Test Başarılı");
                await result.write("38"," BAŞARILI    Görüntü çözünürlüğü doğru.");}
                else
                { console.log("Test Başarısız")
                await result.write("38"," BAŞARISIZ    Görüntünün çözünürlüğü yanlış.");}
                    
                }
                else 
                    await result.write("38"," BAŞARISIZ    Görüntü gelmiyor.");
                break;
            }
            case "39": { //TEST 39
                ...
                if ( (select1 == "e" || select1 == "E") && (select2 =="e"|| select2=="E"))
                {  console.log("Test Başarılı");
                await result.write("39"," BAŞARILI    Görüntü çözünürlüğü doğru.");}
                else
                { console.log("Test Başarısız")
                await result.write("39"," BAŞARISIZ    Görüntünün çözünürlüğü yanlış.");}
                
                }
                else 
                    await result.write("39"," BAŞARISIZ    Görüntü gelmiyor.");
                break;
            }
            case "42": {//TEST 42
                console.log(" ");
                ...
                {  console.log("Test Başarılı");
                await result.write("42"," BAŞARILI    Konfigrasyon ayarları doğru.");}
                else
                { console.log("Test Başarısız")
                await result.write("42"," BAŞARISIZ    Konfigrasyon ayarları yanlış. Yazılım sürümü="+firmware+"  Uygulama sürümü = "+application);}
            ...
            case "43": { //TEST-43
                ...
                if(task_val[2])
                await result.write("43"," BAŞARILI    İstenen göreve dön süresi="+task_val[0]+"  Gerçekleşen göreve dön süresi = "+task_val[1]);
                else
                await result.write("43"," BAŞARISIZ    İstenen göreve dön süresi="+task_val[0]+"  Gerçekleşen göreve dön süresi = "+task_val[1]);
            ...
            case "47": {//TEST-47
                ...
                await page.waitFor(2000);
                for (let i = 0; i < 9; i++){
                    run_active = run_active && await cam.set_patrol_id(page,i+".");
                    await page.waitFor(2000);
                }
                if(run_active) await result.write("47"," BAŞARILI     Tüm patternlerin koş butonu aktif");
                    else await result.write("47"," BAŞARISIZ     Patternlerden en az birinin koş butonu aktif değil");
                console.log("Test is completed!");
                break;
            }
            case "50":{//TEST-50
                ...
                await result.write("50"," BAŞARILI IR Aydınlatma = "+temp_val0[1]+"   IR Cut Filtre Modu = "+temp_val1[1]+"   IR-Cut Filtre Geçişi = "+temp_val2[1]);
                else await result.write("50"," BAŞARISIZ IR Aydınlatma = "+temp_val0[1]+"   IR Cut Filtre Modu = "+temp_val1[1]+"   IR-Cut Filtre Geçişi = "+temp_val2[1]);
                break;
            }
            case "51": {//TEST51
                console.log(" ");
                ...
                if(task_val[2])
                await result.write("51"," BAŞARILI    İstenen göreve dön süresi="+task_val[0]+"  Gerçekleşen göreve dön süresi = "+task_val[1]);
                else
                await result.write("51"," BAŞARISIZ   İstenen göreve dön süresi="+task_val[0]+"  Gerçekleşen göreve dön süresi = "+task_val[1]);
                console.log("Test is completed!");
                break;
            }
            case "52":{
                ...
                if(select0 && select1 && select2) await result.write("52"," BAŞARILI   Kamera IR-Cut Filtre Geçişini otomatik yapabiliyor.")
                else result.write("52"," BAŞARISIZ   Kamera IR-Cut Filtre Geçişini otomatik yapamıyor.")
                console.log("Test is completed!");
                break;
                }
            ...
            case "54":{
                ...
                if (select1=="e"||select1=="E")
                { console.log("Test Başarılı");
                result.write("54"," BAŞARILI")}
                else
                {console.log("Test Başarısız");
                result.write("54"," BAŞARISIZ")}
                break;
            }
            case "55":{
                ...
                if (select1=="e"||select1=="E")
                { console.log("Test Başarılı");
                result.write("55"," BAŞARILI")}
                else
                {console.log("Test Başarısız");
                result.write("55"," BAŞARISIZ")}
                break;
            }
            case "56": {//TEST-56
                console.log("");
                ...
                if (select1=="e"||select1=="E")
                { console.log("Test Başarılı");
                result.write("56"," BAŞARILI   NTP Sunucu1 adresi doğru")}
                else
                {console.log("Test Başarısız");
                result.write("56"," BAŞARISIZ   NTP Sunucu1 adresi yanlış")}
            ...
            case "57":{
                ...
                if (select1=="e"||select1=="E")
                { console.log("Test Başarılı");
                result.write("57"," BAŞARILI   Kamera istenilen çözünürlük ve fps değerinde en az 5 adet unicast yayın akışı başlatabiliyor.")}
                else
                {console.log("Test Başarısız");
                result.write("57"," BAŞARISIZ   Kamera istenilen çözünürlük ve fps değerinde en az 5 adet unicast yayın akışı başlatamıyor.")}
                break;
            }
            case "58": {//TEST-58
                var temp_val = 1;
                ...
                await cam.lighting_level(page,level[7]);
                    await page.waitFor(3000);
                if (temp_val) result.write("58"," BAŞARILI   Tüm IR Aydınlatma seviyeleri düzgün çalışıyor.")
                else result.write("58"," BAŞARISIZ   En az bir IR Aydınlatma seviyesi düzgün çalışmıyor.")
                console.log("Test is completed!");
                break;
            }
            case "61": {
            ...
            case "62": {
                ...
                await test_ffmpeg_res_fps('stream1',62);
                break;
            }
            case "63": {
                await test_set_res_fps_DOM(page,2,1,dom_ip);
                await test_ffmpeg_res_fps('stream1',63);
                break;
            }
            case "64": {
                await test_set_res_fps_DOM(page,3,1,dom_ip);
                await test_ffmpeg_res_fps('stream1',64);
                break;
            }
            case "65": {
                await test_set_res_fps_DOM(page,0,2,dom_ip);
                await test_ffmpeg_res_fps('stream2',65);
                break;
            }
            case "66": {
                await test_set_res_fps_DOM(page,1,2,dom_ip);
                await test_ffmpeg_res_fps('stream2',66);
                break;
            }
            case "67": {
                await test_set_res_fps_DOM(page,2,2,dom_ip);
                await test_ffmpeg_res_fps('stream2',67);
                break;
            }
            case "68": {
                await test_set_res_fps_DOM(page,3,2,dom_ip);
                await test_ffmpeg_res_fps('stream2',68);
                break;
            }
            case "69":{
                console.log("");
                ...
                if (select1=="e"||select1=="E")
                result.write("69"," BAŞARILI   Stream1 için RTSP Kimlik doğrulama çalışıyor");
                else
                result.write("69"," BAŞARISIZ   Stream1 için RTSP Kimlik doğrulama çalışmıyor");
                console.log("Test is completed!");
                break;
            }
            case "70":{
                ...
                select1 = await question.ask("RTSP Kimlik doğrulama ekranı gelip kimlik doğrulama sorunsuz bir şekilde yapılabildi mi? e/h");
                if (select1=="e"||select1=="E")
                result.write("70"," BAŞARILI   Stream2 için RTSP Kimlik doğrulama çalışıyor");
                else
                result.write("70"," BAŞARISIZ   Stream2 için RTSP Kimlik doğrulama çalışmıyor");
                console.log("Test is completed!");
                break;
            }
            case "71":{
                ...
                if (select1=="e"||select1=="E")
                result.write("71"," BAŞARILI   RTSP Kimlik doğrulama kapatılabiliyor.");
                else
                result.write("71"," BAŞARISIZ   RTSP Kimlik doğrulama kapatılamıyor.");
                console.log("Test is completed!");
                break;
            }
            case "72":{
                ...
                if (select1=="e"||select1=="E")
                result.write("72"," BAŞARILI   Kamera en aşağı konumdayken aşağı butonuna basıldığında 180 derece dönüyor ve yukarıya yönelmiyor.");
                else
                result.write("72"," BAŞARISIZ   Kamera en aşağı konumdayken aşağı butonuna basıldığında 180 derece dönmüyor ve yukarıya yöneliyor.");
                break;
            }
            case "73":{
                ...
                if (select1=="e"||select1=="E")
                result.write("73"," BAŞARILI   Kamera en aşağı konumdayken aşağı butonuna basıldığında 180 derece dönüyor ve e-flip hareketini gerçekleştiriyor.");
                else
                result.write("73"," BAŞARISIZ   Kamera en aşağı konumdayken aşağı butonuna basıldığında 180 derece dönmüyor veya e-flip hareketini gerçekleştirmiyor.");
            }
            case "75":{
                ...
                if (select1=="e"||select1=="E")
                result.write("75"," BAŞARILI   Kamera güç kesintisinde konumu değişirse güç geldiğinde eski konumuna dönüyor.");
                else
                result.write("75"," BAŞARISIZ   Kamera güç kesintisinde konumu değişirse güç geldiğinde eski konumuna dönmüyor.");
                break;
            }
            case "77":{//77-78
                var temp_val = 1;
                ...
                {   console.log("Lütfen kamera harekete yeniden başlayıncaya kadar bekleyin ve hareket başladığında zamanı kaydetmek için ENTER'a basın.")
                    ...
                    if (temp_val) {
                        console.log("Test Başarılı")
                        await result.write("77"," BAŞARILI   Son kullanıcı müdahele saati = "+time0+"   Desene yeniden başlama saati = "+time1)
                    }
                    else{
                        console.log("Test Başarısız");
                        await result.write("77"," BAŞARISIZ   Son kullanıcı müdahele saati = "+time0+"  Desene yeniden başlama saati = "+time1)
                    }
                }
                else
                {
                    await result.write("77"," BAŞARISIZ   Kamera desen uygularken zoom kontrolü yollandığında durmuyor."+time1)
                    console.log("Test Başarısız")
                }
            ...
            case "79":{
                ...
                if (select1=="e"||select1=="E")
                {
                    ...
                    { console.log("Test Başarılı");
                        await result.write("79"," BAŞARILI   Kamera yeniden başlatma sonrasında desene devam ediyor.")
                    }
                    else
                    { console.log("Test Başarısız");
                        await result.write("79"," BAŞARISIZ   Kamera yeniden başlatma sonrasında desene devam etmiyor.")
                    }
                }
                else
            ...
            case "80":{
                ...
                if (select1=="e"||select1=="E")
                {
                    ...
                    {
                        console.log("Test Başarılı");
                        await result.write("80"," BAŞARILI   Kamera güç kesintisi sonrasında desene devam ediyor.")
                    }
                    else
                    {
                        console.log("Test Başarısız");
                        await result.write("79"," BAŞARISIZ   Kamera güç kesintisi sonrasında desene devam etmiyor.")
                    }
                }
                else
                console.log("Deseni başlatıp tekrar deneyin . Test sonucu dosyaya KAYDEDİLMEDİ.");
            ...
            case "81":{//81,82,83
                ...
                await result.write("81"," BAŞARILI   Alarm başlama saati: "+time0+"  Alarm bitiş saati = "+time1+" Desene yeniden başlama saati = "+time2)
                else
                await result.write("81"," BAŞARISIZ   ")
                console.log("Test is completed!");
                await cam.pattern_cancel(page);
                break;
            }
            case "84":{//84-94 arası
                ...
                if(select1=="e"||select1=="E"){
                    ...
                    { select2=0;
                        await result.write("85","BAŞARISIZ    Alarm varolduğu sürece DEFNE'ye alarm bilgisi gelmedi.")
                    }
                    select3 = await question.ask("Alarm oluşturulduğunda kamera girilen Preset değerine hareket etti mi? e/h");
                    if(select3=="e"||select3=="E")
                    select3=1;
                    ...
                    { select3=0;
                        await result.write("85","BAŞARISIZ    Alarm oluşturulduğunda kamera girilen Preset değerine hareket etmedi.")
                    }
                    var text = " ";
                    if(select2 && select3){
                        text = (i+1)+".Alarm başlangıç saati = "+times_basla[i]+"....."+(i+1)+".Alarm bitiş saati = "+times_bitis[i]+"    ";
                        await result.write("85","BAŞARILI    "+1+".Alarm başlangıç saati = "+times_basla[0]+"....."+1+".Alarm bitiş saati = "+times_bitis[0])
                        for(let i= 1; i<5; i++)
                        {
                            text = (i+1)+".Alarm başlangıç saati = "+times_basla[i]+"....."+(i+1)+".Alarm bitiş saati = "+times_bitis[i]+"    ";
                            await result.write("85","........."+text)
                        }
                    ...
                    console.log("Test Başarısız");
                    await result.write("85","BAŞARISIZ    Kamera deseni gerçekleştirmiyor.")
                }
                console.log("Test is completed!");
                await cam.pattern_cancel(page);
                break;
            ...
            case "95":{//95-98 arası
                ...
                if(select1=="e"||select1=="E")
                {
                    ...
                    await result.write("95","BAŞARILI    Alarm başlama saati:"+times[0]+"Alarm bitiş saati: "+times[1]+"Kullanıcı müdahele etme saati:"+times[2]+"Hareket olmadığının en son kontrol edildiği saat: "+times[3]);
                    else await result.write("95","BAŞARISIZ    Alarm başlama saati:"+times[0]+"Alarm bitiş saati: "+times[1]+"Kullanıcı müdahele etme saati:"+times[2]+"Hareket olmadığının en son kontrol edildiği saat: "+times[3]);
                    
                }
                else
                { console.log("Test Başarısız");    await result.write("95","BAŞARISIZ    Kamera deseni gerçekleştirmiyor.")}
                console.log("Test is completed!");
                await cam.pattern_cancel(page);
                break;
            }
            case "99":{//99-101 arası
                ...
                if(select1=="e"||select1=="E"){
                    ...
                    console.log("ALarm bitiş saati: "+times[1])
                    if(select2 && select3 && select4)
                    await result.write("99","BAŞARILI    Alarm başlama saati:"+times[0]+"Alarm bitiş saati: "+times[1]+"Hareket olmadığının en son kontrol edildiği saat: "+times[2]);
                    else await result.write("99","BAŞARISIZ    Alarm başlama saati:"+times[0]+"Alarm bitiş saati: "+times[1]+"Hareket olmadığının en son kontrol edildiği saat: "+times[2]);
                }
                else
                { console.log("Test Başarısız"); await result.write("95","BAŞARISIZ    Kamera deseni gerçekleştirmiyor.")}
                console.log("Test is completed!");
            ...
            case "102":{//102-105
                ...
                if(select1=="e"||select1=="E")
                {
                    ...
                    console.log("ALarm bitiş saati: "+times[1])
                    if(select2 && select3 && select4)
                    await result.write("102","BAŞARILI    Alarm başlama saati:"+times[0]+"Alarm bitiş saati: "+times[1]+"Kullanıcı müdahele etme saati:"+times[2]+"Hareket olmadığının en son kontrol edildiği saat: "+times[3]);
                    else await result.write("95","BAŞARISIZ    Alarm başlama saati:"+times[0]+"Alarm bitiş saati: "+times[1]+"Kullanıcı müdahele etme saati:"+times[2]+"Hareket olmadığının en son kontrol edildiği saat: "+times[3]);
                    
                }
                else
                { console.log("Test Başarısız");    await result.write("102","BAŞARISIZ    Kamera deseni gerçekleştirmiyor.")}
                console.log("Test is completed!");
                await cam.pattern_cancel(page);
                break;
            }
            case "107":{
                ...
                if(select1)
                {
                    if(select2){
                        if(select3){
                            if(select4){
                                await result.write("107","BAŞARILI    Son kullanıcı saati = "+time1+"Patrola yeniden başlama saati = "+time2);
                            }
                            else await result.write("107","BAŞARISIZ    Son kullanıcı saati = "+time1+"Patrola yeniden başlama saati = "+time2);
                        }
                        else await result.write("107","BAŞARISIZ    Patrole devam ederken sağa dön komutu verildiğinde patrol durdurulmadı.");
                    }
                    else await result.write("107","BAŞARISIZ    Patrol girilen presetlerde belirlenen süre kalmadı.");
                }
                else await result.write("107","BAŞARISIZ    Patrol girilen presetlere gitmedi.");
            ...
            case "109":{
                ...
                if (select1=="e"||select1=="E")
                {
                    ...
                    if (select=="e"||select=="E")
                    { console.log("Test Başarılı");
                    await result.write("109","BAŞARILI    Kamera yeniden başlatıldıktan sonra önce yapmakta olduğu işe devam ediyor.");}
                    else
                    { console.log("Test Başarısız");
                    await result.write("109","BAŞARISIZ    Kamera yeniden başlatıldıktan sonra önce yapmakta olduğu işe devam etmiyor.");}
                }
                else
            ...
            case "110":{
                ...
                if (select1=="e"||select1=="E")
                {
                    ...
                    if (select=="e"||select=="E")
                    { console.log("Test Başarılı");
                    await result.write("110","BAŞARILI    Kamera güç kesintisinden sonra önce yapmakta olduğu işe devam ediyor.");}
                    else
                    { console.log("Test Başarısız");
                    await result.write("110","BAŞARISIZ    Kamera güç kesintisinden sonra önce yapmakta olduğu işe devam etmiyor.");}
                }
                else
                console.log("Patrol hareketini başlatıp tekrar deneyin");
                await ppp.break_patrol(page);
            ...
            case "111":{
                ...
                {  select1 = 0;
                await result.write("111","BAŞARISIZ    Alarm başlatıldığında kamera Alarm presetine yönelmedi.");}
                select2 = await question.ask("Alarm varolduğu süre boyunca DEFNE yazılımında alarm bilgisi mevcutmuydu? e/h");
                if (select2=="e"||select2=="E")
                select2 = 1;
                else
                {  select2 = 0;
                await result.write("111","BAŞARISIZ    Alarm varolduğu süre boyunca DEFNE yazılımında alarm bilgisi mevcut değildi.");}
                if (select1 && select2)  await result.write("111","BAŞARILI    Alarma başlama saati = "+times0+"Alarm bitiş saati = "+times1+"Patrole yeniden başlama saati = "+times2);
 console.log("Test done");
 break;
            }
            case "114":{
                ...
                if(select1 ){
                    if(select2){
                        text = (i+1)+".Alarm başlangıç saati = "+times_basla[i]+"....."+(i+1)+".Alarm bitiş saati = "+times_bitis[i]+"    ";
                        await result.write("114","BAŞARILI    "+1+".Alarm başlangıç saati = "+times_basla[0]+"....."+1+".Alarm bitiş saati = "+times_bitis[0])
                        for(let i= 1; i<5; i++)
                        {
                            text = (i+1)+".Alarm başlangıç saati = "+times_basla[i]+"....."+(i+1)+".Alarm bitiş saati = "+times_bitis[i]+"    ";
                            await result.write("114","........."+text)
                        }
                        text = "Desene yeniden başlama saati:"+time_patrol;
                        await result.write("114","........."+text)
                    }
                    else  await result.write("114","BAŞARISIZ    Alarm varolduğu süre boyunca DEFNE yazılımında alarm bilgisi mevcut değildi.")
                }
                else{
                    console.log("Test Başarısız");
                    await result.write("114","BAŞARISIZ    Alarm başlatıldığında kamera Alarm Presetine yönelmedi")
                }
            ...
            case "125" : {
                ...
                if(select1)
                {
                    ...
                    {
                        if(select3)
                        await result.write("125","BAŞARILI    Alarm başlatıldığında kamera Alarm Presetine yönelmedi")
                        else
                        await result.write("125","BAŞARISIZ    Kamera patrole yeniden başladı")
                    }
                    else
                    await result.write("125","BAŞARISIZ    Alarm var olduğu sürece DEFNEde sol üst köşede SEI Alarm bilgisi gelmedi")
                }
                else
                await result.write("125","BAŞARISIZ    Alarm başlatıldığında kamera Alarm Presetine yönelmedi")
                await ppp.break_patrol(page);
                break;
            }
            case "129" : {
                ...
                if (select=="e" || select == "E")
                {
                    ...
                    if (select0=="H" || select0 == "h")
                    {
                        ...
                        if (select1=="e"||select1=="E")
                        {
                            result.write("129","BAŞARILI    Alarm başlama saati"+times[0]+"Alarmı sonlandırma saati:"+times[1]+"Hareket olmadığının en son kontrol edildiği saat:"+times[2])
                        }
                        else result.write("129","BAŞARISIZ    Alarm başlatıldığına kamera alarm presetine yönelmiyor.")
                    }
                    else result.write("129","BAŞARISIZ    Kamera patrole yeniden başlıyor.")
                }
                else result.write("129","BAŞARISIZ    Kamera patrole başlamıyor. Lütfen tekrar deneyin.")
                    await ppp.break_patrol(page);
                break;
            }
            case "132" : {
                ...
                if (select0=="H" || select0 == "h")
                {
                    ...
                    if (select1=="e"||select1=="E")
                    {
                        result.write("132","BAŞARILI    Alarm başlama saati"+times[0]+"Alarmı sonlandırma saati:"+times[1]+"Hareket olmadığının en son kontrol edildiği saat:"+times[3])
                    }
                    else result.write("132","BAŞARISIZ    Alarm başlatıldığında kamera alarm presetine yönelmiyor.")
                }
                else result.write("132","BAŞARISIZ    Kamera patrole yeniden başlıyor.")
            break; }
        ...
        case "137": {//TEST-137
            ...
            if (select2 == 'E' || select2 == 'e')
            {if(select == "visible")
                await result.write("137","BAŞARILI    Stop butonu aktif ve otopan hareketleri gerçekleştirildi.")
                else await result.write("137","BAŞARISIZ    Kamera otopan hareketini gerçekleştirmedi.")
            }
            else
            await result.write("137","BAŞARISIZ    Stop butonu aktif değil.")
            console.log("Test is completed!");
            break;
        }
        case "138": {//TEST-138
            ...
            if (select2 == 'E' || select2 == 'e')
            {if(select == "visible")
                await result.write("138","BAŞARILI    Stop butonu aktif ve otopan hareketleri gerçekleştirildi.")
                else await result.write("138","BAŞARISIZ    Kamera otopan hareketini gerçekleştirmedi.")
            }
            else
            await result.write("138","BAŞARISIZ    Stop butonu aktif değil.")
            console.log("Test is completed!");
            break;
        }
        case "139": {//TEST-139
            ...
            if (select2 == 'E' || select2 == 'e')
            {if(select == "visible")
                await result.write("139","BAŞARILI    Stop butonu aktif ve otopan hareketleri gerçekleştirildi.")
                else await result.write("139","BAŞARISIZ    Kamera otopan hareketini gerçekleştirmedi.")
            }
            else
            await result.write("139","BAŞARISIZ    Stop butonu aktif değil.")
            break;
        }
        case "140": {//TEST-140
            console.log("");
            ...
            if (select2 == 'E' || select2 == 'e')
            {if(select == "visible")
                await result.write("140","BAŞARILI    Stop butonu aktif ve otopan hareketleri gerçekleştirildi.")
                else await result.write("140","BAŞARISIZ    Kamera otopan hareketini gerçekleştirmedi.")
            }
            else
            await result.write("140","BAŞARISIZ    Stop butonu aktif değil.")
            console.log("Test is completed!");
            break;
        }
        case "141":{//141-142
            ...
            if(select=="e"||select=="E")
            {
                ...
                if (select2=="e"||select2=="E"){
                    ...
                    await result.write("141","BAŞARILI     Son müdehale saati:"+command+"Otopan hareketine yeniden başlama saati:"+command1);
                }
                else await result.write("141","BAŞARISIZ     Kamera otopan hareketine yeniden başlamadı.");
                 
                }
                else await result.write("141","BAŞARISIZ     Kamera PTZ hareketinden sonra otopan hareketine devam etti.");
                
                
            }
            else await result.write("141","BAŞARISIZ     Kamera otopan hareketine başlamadı. Tekrar deneyin.");
            await cam.stop(page);
            console.log("Test is completed!");
            break;
        }
        case "143": {//TEST-143
            ...
            if (select=="e"||select=="E")
            {console.log("Test Başarılı"); await result.write("141","BAŞARILI     Kamera yeniden başlatma sonrası otopan hareketine devam etti");}
            else
            {console.log("Test Başarısız"); await result.write("141","BAŞARISIZ     Kamera yeniden başlatma sonrası otopan hareketine devam etmedi");}}
            ...
            if (select1=="e"||select1=="E")
                {
                    ...
                    select = await question.ask("Kamera açıldıktan sonra otopan hareketine devam etti mi? e/h");
            if (select=="e"||select=="E")
            {console.log("Test Başarılı"); await result.write("142","BAŞARILI     Kamera güç kesintisi sonrası otopan hareketine devam etti");}
            else
            {console.log("Test Başarısız"); await result.write("142","BAŞARISIZ     Kamera güç kesintisi sonrası otopan hareketine devam etmedi");}
                }
                else
        ...
        case "145":{//145,146,147
            ...
            if(select=="e"||select=="E"){
                ...
                if(select3=="e"||select3=="E")
                {
                    await result.write("145","BAŞARILI Alarm başlama saati:"+times[0]+" Alarm bitiş saati :"+times[1]+" Otopana yeniden başlama saati:"+times[2]);
                }
                else
                {
                    await result.write("145","BAŞARISIZ    Alarm oluştuğunda kamera alarm presetine yönelmedi.");
                }
                }
                else
                    await result.write("145","BAŞARISIZ    Alarm varolduğu süre boyunca DEFNEde SEI Alarm bilgisi gelmedi.");
               
            }
            else
            {
                    await result.write("145","BAŞARISIZ     Kamera otopan hareketini gerçekleştirmedi.Tekrar deneyin.");
            console.log("Test Başarısız");}
            console.log("Test is completed!");
                await cam.stop(page);
            break;
        ...
        case "148":{//148-158 arası
            ...
            if(select=="e"||select=="E"){
                ...
                if(select1 ){
                    if(select2){
                        text = (i+1)+".Alarm başlangıç saati = "+times_basla[i]+"....."+(i+1)+".Alarm bitiş saati = "+times_bitis[i]+"    ";
                        await result.write("148","BAŞARILI    "+1+".Alarm başlangıç saati = "+times_basla[0]+"....."+1+".Alarm bitiş saati = "+times_bitis[0])
                        for(let i= 1; i<5; i++)
                        {
                            text = (i+1)+".Alarm başlangıç saati = "+times_basla[i]+"....."+(i+1)+".Alarm bitiş saati = "+times_bitis[i]+"    ";
                            await result.write("148","........."+text)
                        }
                        text = "Desene yeniden başlama saati:"+time_patrol;
                        await result.write("148","........."+text)
                    }
                    else  await result.write("148","BAŞARISIZ    Alarm varolduğu süre boyunca DEFNE yazılımında alarm bilgisi mevcut değildi.")
                }
                else{
                    console.log("Test Başarısız");
                    await result.write("148","BAŞARISIZ    Alarm başlatıldığında kamera Alarm Presetine yönelmedi")
                }
                
            }
            else result.write("148","BAŞARISIZ    Otopan alarm sonlandırıldıktan sonra tekrar başlamıyor.")
            }
            else
                await result.write("148","BAŞARISIZ    Otopan başlatılamadı tekrar deneyin.")
                await cam.stop(page);
                console.log("Test done")
                break;
         }
        case "159":{//159-162 arası
            ...
            if(select=="e"||select=="E"){
                ...
                if(select2=="e"||select2=="E")
                {
                    select3 = await question.ask("Alarm oluşturulduğunda kamera girilen Preset değerine hareket etti mi? e/h");
                if(select3=="e"||select3=="E")
                    await result.write("159","BAŞARILI     Alarm başlama saati:"+times[0]+)
                else
                select3=0;
                ...
                else await result.write("159","BAŞARISIZ    Kamera serbest süre geçtikten sonra otopana devam ediyor.")
            }
            else
            console.log("Test Başarısız");
            console.log("Test is completed!");
        ...
        case "180":{
            console.log("");
            console.log("TEY-2_ver06 Test-180 Başladı");
            await nav_dome.toWatchCamera(page,ip);
            await watch_camera.select_mask(page,1);
            await watch_camera.mask_orientation(page);
            await watch_camera.mask_width(page);
            await watch_camera.mask_height(page);
            await watch_camera.check_show(page);
            await watch_camera.mask_update(page);
            console.log("Maske güncellendi!");
            break;
        }
        case "181":{
            console.log("");
            console.log("TEY-2_ver06 Test-181 Başladı");
            await nav_dome.toWatchCamera(page,ip);
            for(var i=1; i<25; i++){
                await watch_camera.select_mask(page,i);
                await watch_camera.mask_orientation(page);
                await watch_camera.mask_width(page);
                await watch_camera.mask_height(page);
                await watch_camera.check_show(page);
            ...
            select4 = await question.ask("Kameranın bakış açısı değiştirilerek tüm maskeler görüntülenebiliyor mu? e/h");
            if(select4=="e"||select4=="E")
            console.log("Test Başarılı!");
            else
            console.log("Test Başarısız!");
